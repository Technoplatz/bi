...
import { Component, OnInit, HostListener, Input, ViewChild, ChangeDetectionStrategy } from "@angular/core";
import { UntypedFormBuilder, UntypedFormGroup } from "@angular/forms";
import { AlertController, IonButton, IonCheckbox, IonCol, IonContent, IonDatetime, IonDatetimeButton, IonGrid, IonHeader, IonIcon, IonInput, IonItem, IonLabel, IonList, IonModal, IonRow, IonSearchbar, IonSelect, IonSelectOption, IonSpinner, IonTextarea } from "@ionic/angular";
...
@Component({
  ...
  imports: [CommonModule, FormsModule, ReactiveFormsModule, TranslatePipe, IonButton, IonCheckbox, IonCol, IonContent, IonDatetime, IonDatetimeButton, IonGrid, IonHeader, IonIcon, IonInput, IonItem, IonLabel, IonList, IonModal, IonRow, IonSearchbar, IonSelect, IonSelectOption, IonSpinner, IonTextarea, KovComponent, ModalFooterComponent],
  selector: "app-crud",
