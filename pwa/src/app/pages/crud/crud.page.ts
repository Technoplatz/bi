    ...
    return new Promise((resolve, reject) => {
      this.misc.apiCall("crud", {
        ...
        match: [{
          key: "col_id",
          op: "eq",
          value: coll_ === "_collection" ? this.data_["col_id"] : coll_ === "_permission" ? this.data_["per_collection_id"] : coll_ === "_automation" ? this.data_["aut_source_collection_id"] : coll_ === "_action" ? this.data_["act_collection_id"] : coll_ === "_view" ? this.data_["vie_collection_id"] : coll_ === "_action" ? this.data_["act_collection_id"] : coll_
        }],
        sort: null,
        page: 1,
        limit: 1
