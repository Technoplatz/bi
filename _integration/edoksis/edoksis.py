...
EDOKSIS_XML_SIZE_ = int(str(os.environ.get("EDOKSIS_XML_SIZE")))
EDOKSIS_ISSUE_DELAY_ = int(str(os.environ.get("EDOKSIS_ISSUE_DELAY")))
...
@app.route("/issue", methods=["POST"], endpoint="multi-issue")
def multi_issue_f():
    """
    docstring is in progress
    """
